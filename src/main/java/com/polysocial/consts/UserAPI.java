...
public class UserAPI {
    ...
    public static final String  API_GET_ALL_USER = "/user/get-all";

    public static final String  API_GET_ONE_USER = "/user/get-one";
    ...
    public static final String  API_ACCEPT_FRIEND = "/user/accept-friend";

    public static final String  API_DELETE_REQUEST_ADD_FRIEND = "/user/delete-request-add-friend";
